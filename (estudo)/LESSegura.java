...
class Lista<T>{
    ...
    public void inserir(T v) throws MeuErro{
        if(this.cheia()) throw new MeuErro("Runtime Error: Lista cheia.");
            int i = 0;
            while(i<this.getQuantidade() && (Integer)v>(Integer)this.getItens(i))
                i++;
    ...
    public void remover(T v) throws MeuErro{
    ...
    public void buscar(T v) throws MeuErro{
        if(this.vazia())throw new MeuErro("Runtime Error: Lista Vazia.");
...
public class LESSegura{
    public static void main(String[] args){
        Scanner scan = new Scanner(System.in);
        int n = scan.nextInt();
        Lista<Integer> lista = new Lista<Integer>(n);
